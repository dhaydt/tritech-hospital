...
@section('content')
@include('admin-views.business-settings.partials._headerBussines')
<div class="content container-fluid mt--9">
    <div class="row" style="padding-bottom: 20px;">
        <div class="col-md-12 mb-3 mt-3">
            <div class="alert alert-danger mb-3" role="alert">
                Changing some settings will take time to show effect please clear session or wait for 60 minutes else
                browse from incognito mode
            </div>
    ...
    <div style="padding: 10px;background: white;border-radius: 10px; text-align: {{Session::get('direction') === " rtl"
        ? 'right' : 'left' }};">
        <h3>Web config Form</h3>
        <form action="{{ route('admin.web-config.update-info') }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{-- <div class="row" style="padding-bottom: 20px">
                        ...
                        <div class="card-header">
                            <div class="flex-between">
                                ...
                                <div class="{{Session::get('direction') === " rtl" ? 'mr-1' : 'ml-1' }}"><small
                                        style="color: red">{{('Ratio')}} ( {{('6:1')}} )</small></div>
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="company_email"
                            value="{{ $company_email->value?$company_email->value:" " }}" placeholder="New Business">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="company_phone"
                            value="{{ $company_phone->value?$company_phone->value:"" }}" placeholder="New Business">
                    </div>
                </div>
                <div class="col-md-6">
                    @php($pagination_limit=\App\CPU\Helpers::get_business_settings('pagination_limit'))
                    <div class="form-group">
                        <label class="input-label">pagination settings</label>
                        <input type="number" value="{{$pagination_limit}}" name="pagination_limit" class="form-control"
                            placeholder="25">
                    </div>
                </div>
                {{-- <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="input-label">{{('rename_company')}} {{('copy_right')}} {{('Text')}}</label>
            ...
            <div class="row" style="padding-bottom: 20px">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="input-label d-inline text-capitalize">{{('time')}} {{('zone')}}</label>
                        <select name="timezone" class="form-control js-select2-custom">
                            ...
                            <option value="America/Argentina/Buenos_Aires" {{$tz?($tz=='America/Argentina/Buenos_Aires'
                                ?'selected':''):''}}>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="input-label d-inline text-capitalize">{{('country')}} </label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="input-label d-inline text-capitalize">{{('forgot_password_verification_by')}}
                        </label>
            ...
            {{-- Verivication phone, email, order --}}
            {{-- <div class="row">
                        ...
                        <div class="input-group input-group-md-down-break">
                            ...
                            <div class="form-control">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="1" name="phone_verification"
                                        id="phone_verification_on" {{(isset($pv) && $pv==1)?'checked':''}}>
                                    <label class="custom-control-label" for="phone_verification_on">{{('on')}}</label>
                                </div>
                            </div>
                            <!-- End Custom Radio -->
                            ...
                            <div class="form-control">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="0" name="phone_verification"
                                        id="phone_verification_off" {{(isset($pv) && $pv==0)?'checked':''}}>
                                    <label class="custom-control-label" for="phone_verification_off">{{('off')}}</label>
                                </div>
                            </div>
                            <!-- End Custom Radio -->
                        </div>
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="form-group">
                        <label>{{('email')}} {{('verification')}}</label><small style="color: red">*</small>
                        <div class="input-group input-group-md-down-break">
                            <!-- Custom Radio -->
                            <div class="form-control">
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="email_verification_on">{{('on')}}</label>
                                </div>
                            </div>
                            <!-- End Custom Radio -->
                            ...
                            <div class="form-control">
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="email_verification_off">{{('off')}}</label>
                                </div>
                            </div>
                            <!-- End Custom Radio -->
                        </div>
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="form-group">
                        <label>{{('order')}} {{('verification')}}</label><small style="color: red">*</small>
                        <div class="input-group input-group-md-down-break">
                            <!-- Custom Radio -->
                            <div class="form-control">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="1" name="order_verification"
                                        id="order_verification1" {{$order_verification==1?'checked':''}}>
                                    <label class="custom-control-label" for="order_verification1">{{('on')}}</label>
                                </div>
                            </div>
                            <!-- End Custom Radio -->
                            ...
                            <div class="form-control">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="0" name="order_verification"
                                        id="order_verification2" {{$order_verification==0?'checked':''}}>
                                    <label class="custom-control-label" for="order_verification2">{{('off')}}</label>
                                </div>
                            </div>
                            <!-- End Custom Radio -->
                        </div>
                            ...
                            <div class="row pl-4 pr-4">
                                <div class="col-12" style="text-align: left">
                                    <input type="file" name="company_web_logo" id="customFileUploadWL"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="customFileUploadWL">{{('choose')}}
                                        {{('file')}}</label>
                                </div>
                            ...
                            <div class="row pl-4 pr-4">
                                <div class="col-12" style="text-align: left">
                                    <input type="file" name="company_mobile_logo" id="customFileUploadML"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="customFileUploadML">{{('choose')}}
                                        {{('file')}}</label>
                                </div>
                            </div>
                        ...
                        <div class="card-body" style="padding: 20px">
                            <center>
                                <img width="233" id="viewerWFS"
                                    onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                    src="{{asset('storage/company')}}/{{\App\models\BusinessSetting::where(['type' => 'flash_sale_banner'])->pluck('value')[0]}}">
                            </center>
                            <hr>
                            <div class="row pl-4 pr-4">
                                <div class="col-12" style="text-align: left">
                                    <input type="file" name="flash_sale_banner" id="customFileUploadWFS"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="customFileUploadWFS">{{('choose')}}
                                        {{('file')}}</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row pl-4 pr-4">
                                <div class="col-12" style="text-align: left">
                                    <input type="file" name="company_footer_logo" id="customFileUploadWFL"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="customFileUploadWFL">{{('choose')}}
                                        {{('file')}}</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row pl-4 pr-4">
                                <div class="col-12" style="text-align: left">
                                    <input type="file" name="company_fav_icon" id="customFileUploadFI"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="customFileUploadFI">{{('choose')}}
                                        {{('file')}}</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row pl-4 pr-4">
                                <div class="col-12" style="text-align: left">
                                    <input type="file" name="loader_gif" id="customFileUploadLoader"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="customFileUploadLoader">{{('choose')}}
                                        {{('file')}}</label>
                                </div>
                            </div>
                        </div>
