            ...
            <div class="card bg-secondary shadow border-0">
                <div class="card-header bg-transparent pb-5">
                    ...
                    <div class="text-center">
                        <a href="javascript:" class="btn btn-neutral btn-icon mr-4">
                ...
                <div class="card-body px-lg-5 py-lg-5">
                    ...
                    <form class="js-validate" role="form" method="POST" action="{{ route('customersReg_submit') }}">
                        @csrf

                        <div class="js-form-message form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="ni ni-hat-3"></i></span>
                                </div>
                                <input class="pl-2 form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                ...
                                <input class="pl-2 form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}"
                                    placeholder="{{ __('Phone') }}" type="number" name="phone"
                        ...
                        <div class="js-form-message form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            <div class="input-group input-group-alternative mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input class="pl-2 form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                    ...
                                    required id="signinSrEmail" required data-msg="Please enter a valid email address.">
                            </div>
                            @if ($errors->has('email'))
                            <span class="invalid-feedback" style="display: block;" role="alert">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="pl-2 form-control" placeholder="{{ __('Confirm Password') }}" type="textt"
